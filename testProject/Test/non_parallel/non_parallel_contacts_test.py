...
class NonParallelContactsPageTests(unittest.TestCase):
    ...
    def test_delete_all_accounts_that_have_same_name(self):
        ...
        status = self.contacts_Page.delete_contacts("New account", "all")
        self.assertTrue(status, "test_delete_all_accounts_that_have_same_name did not succeed")

    def test_delete_all_account_and_undo(self):
        print("test_delete_all_account_and_undo")
        status = self.contacts_Page.undo_delete_all_contacts()
